...
export const workAreas: Array<{
  ...
  },
  {
    ...
    title: '행사 미디어',
    english: 'Event Media',
    description: '행사와 협정식 현장에서 바로 활용할 수 있는 송출 화면과 운영 도구를 제작합니다.',
  },
  {
    id: 'platform',
    number: '04',
...
export const repositories: RepositoryRecord[] = [
  ...
  },
  {
    ...
    displayName: 'AI 기술과 활용 직원교육 공개본',
    area: 'education',
    summary: '공개 범위를 선별한 4개 강의와 출처, 결과보고서·디자인 가이드를 연결한 직원교육 웹 슬라이드입니다.',
    language: 'HTML',
    status: 'live',
    statusLabel: '공개 슬라이드',
    repositoryUrl: 'https://github.com/dongjinshin-kookmin/ai-staff-training',
    liveUrl: 'https://dongjinshin-kookmin.github.io/ai-staff-training/',
    pageNote: 'main 직접 배포 · HTTP 200 확인 · 공개용 자료 선별 및 개인정보 패턴 점검',
    startedAt: '2026.07.21',
    commits: [
      { sha: 'c528dae', date: '2026.07.22', message: '공개 슬라이드의 시연 링크 안전화', branch: 'main' },
      { sha: 'cf95ef5', date: '2026.07.22', message: '2장 AI 미디어 제작 스텝을 단계별 개별 슬라이드로 확장', branch: 'main' },
      { sha: 'a1932ad', date: '2026.07.22', message: '마크다운 에디터 스크린샷 최신화 + 바로가기 버튼 추가', branch: 'main' },
      { sha: '46354f3', date: '2026.07.22', message: '강조·커버 색을 로열블루로 전면 교체', branch: 'main' },
      { sha: 'c769ab3', date: '2026.07.22', message: '디자인 가이드 5종 전면 재제작 (애플·피그마·구글·국민대 로얄블루/그린)', branch: 'main' },
      { sha: '22e0f03', date: '2026.07.22', message: '1장 AI는 일하는 동료 슬라이드 배경 교체', branch: 'main' },
      { sha: '0fdebb1', date: '2026.07.22', message: '스크롤 개선: snap 완화(proximity)+키보드 내비게이션', branch: 'main' },
      { sha: 'b8ee991', date: '2026.07.21', message: '슬라이드 세로 넘침 수정 — 15개 슬라이드를 한 화면에 수납', branch: 'main' },
      { sha: 'cbea762', date: '2026.07.21', message: '강의자료 수정: 연도(2026)·마무리 슬라이드 중앙 배치·강의2 영상 포함', branch: 'main' },
      { sha: '57d6c85', date: '2026.07.21', message: '크레딧 팝업 스크린샷의 정책·일정 문구 추가 블러', branch: 'main' },
      { sha: '60ea37d', date: '2026.07.21', message: '국민대 직원교육 생성형 AI 강의자료 공개', branch: 'main' },
    ],
  },
  {
  ...
  },
  {
    ...
    displayName: '디지털 백드롭',
    area: 'media',
    summary: '행사 현장에서 사용한 디지털 백드롭 화면을 공개용 기록으로 보존한 저장소입니다.',
    language: 'HTML',
    status: 'archive',
    statusLabel: '디지털 백드롭 기록',
...
export const workRecords: WorkRecord[] = [
  {
    ...
    status: '공개 슬라이드',
    repositoryIds: ['ai-staff-training'],
    highlights: ['4개 강의·공개 웹덱', '가상 워크숍 자료·디자인 가이드 5종', '공개 범위 선별·개인정보 패턴 점검'],
    note: '공개용으로 선별한 새 저장소의 슬라이드를 연결합니다. 기존 교육 저장소는 공개 범위 재점검 상태로 작업 이력에만 남겨둡니다.',
    image: '/media/project-training.jpg',
    imageAlt: 'AI 기술과 활용 직원교육 웹 콘텐츠',
    primaryUrl: 'https://dongjinshin-kookmin.github.io/ai-staff-training/교육자료/AI기술과활용_직원교육_강의페이지.html',
    primaryLabel: '직원교육 슬라이드 보기',
  },
  {
    id: 'performance',
    number: '02',
    ...
    note: '성과 총람의 성과 맵을 중심으로 전체 구성원의 분포와 지표 탐색 흐름을 확인할 수 있습니다.',
  ...
  },
  {
    ...
    note: '관리자 둘러보기로 실제 시간표 배치 화면과 충돌 검사 흐름을 확인할 수 있습니다.',
  ...
  },
  {
    ...
    title: '디지털 백드롭',
    summary: '행사 현장용 화면과 행사·세미나·협정식에 재사용할 수 있는 단일 HTML 편집 도구를 함께 공개합니다.',
    status: '2개 공개 저장소',
    repositoryIds: ['digital-backdrop', 'nkust-mou-backdrop'],
    highlights: ['메인·촬영 화면 전환', '텍스트·로고·자간 화면 편집', '별도 서버 없는 단일 HTML'],
    note: '행사별 화면과 범용 도구를 분리해 디지털 백드롭의 제작 기록과 재사용 버전을 함께 보존합니다.',
  ...
  },
  {
    ...
    note: '센터 홈페이지의 독립 빌드 엔트리로 분리해 성과관리시스템의 라우팅·데이터·레이아웃에 의존하지 않습니다. NameThatUI의 공개 용어 인덱스를 참고하되 설명과 도판은 새로 작성했습니다.',
